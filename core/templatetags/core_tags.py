...
ICON_PATHS = {
    ...
    "telegram": '<path d="M21 4 3 11l5.7 2.1L17 7l-6.3 7.1V20l3.4-3.3 4.6 3L21 4Z"/>',
    "whatsapp": '<path d="M12 4a8 8 0 0 0-6.9 12l-1.1 4.1 4.2-1.1A8 8 0 1 0 12 4Zm4.5 11.2c-.2.6-1.1 1.1-1.5 1.2-.4.1-.9.2-1.5 0-1-.3-2.2-.9-3.6-2.3-1.7-1.6-2.7-3.5-3-4-.3-.6 0-1.3.2-1.7.2-.3.5-.6.8-.6h.6c.2 0 .4 0 .6.5.2.5.7 1.7.8 1.8.1.2.1.4 0 .6-.1.2-.2.4-.4.6l-.4.4c-.2.2-.3.3-.1.7.2.4.8 1.4 1.8 2.2 1.2 1 2.1 1.3 2.5 1.5.4.1.6 0 .8-.2l.7-.8c.2-.2.4-.2.7-.1l1.7.8c.3.1.5.2.5.4 0 .2 0 1-.2 1.4Z"/>',
