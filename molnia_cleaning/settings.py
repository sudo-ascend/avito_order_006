...
def sqlite_name_from_url(database_url: str) -> Path:
    prefix = "sqlite:///"
...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-molnia-cleaning-dev")
...
ROOT_URLCONF = 'molnia_cleaning.urls'
...
WSGI_APPLICATION = 'molnia_cleaning.wsgi.application'
